  ...
  return (
    <div className="min-h-screen bg-agro-bg">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-73px)]">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-agro-green-light border border-agro-border flex items-center justify-center mx-auto mb-6">
          ...
          <p className="text-agro-muted text-lg mb-8 max-w-md mx-auto">
            Your dashboard is being prepared. We're building something amazing for you.
          </p>
          <div className="inline-flex items-center gap-2 bg-agro-green-light text-agro-green text-sm font-semibold px-4 py-2 rounded-full border border-agro-green/20">
            <span className="w-2 h-2 rounded-full bg-agro-green animate-pulse" />
            Coming Soon
          </div>
        </motion.div>
      </div>
